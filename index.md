...
address: "NASA Langley Research Center, Hampton, VA"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
<div id="openrefine"> {% comment %} Start of 'OpenRefine' section. {% endcomment %}
  ...
  <div class="row">
    <div class="col-md-4">
      ...
      <p>Launch OpenRefine by clicking <code>google-refine.exe</code> (this will launch a command prompt window, but you can ignore that - just wait for OpenRefine to open in the sbrowser).</p>
